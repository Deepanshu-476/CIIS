...
import {
  ...
  useMediaQuery, useTheme, Chip, IconButton, Tooltip,
  Divider, List, ListItem, ListItemText, Tabs, Tab
} from '@mui/material';
import {
  Add as AddIcon,
...
const emailTemplates = [
  {
    ...
    subject: 'Your Upcoming Appointment with {company}',
    content: "Dear {name},\n\nWe are pleased to confirm your appointment with {company} on {date} at {time}. Please arrive 10 minutes early.\n\nBest regards,\n{company}",
    createdBy: 'Admin',
  ...
  },
  {
    ...
    subject: 'Payment Confirmation for {service}',
    content: "Dear {name},\n\nThank you for your payment of {amount} for {service}. Your transaction is complete.\n\nBest,\n{company}",
    createdBy: 'Manager',
    process: 'div',
    visibility: 'My Templates',
    status: 'active',
    lastUpdated: '2025-07-15',
    variables: ['name', 'amount', 'service', 'company']
  },
  {
    id: 3,
    title: 'Feedback Request',
    subject: 'We Value Your Feedback',
    content: "Dear {name},\n\nWe hope you enjoyed your recent {service} experience. Please share your feedback by replying to this email.\n\nThank you,\n{company}",
    createdBy: 'Admin',
    process: 'Default process',
    visibility: 'All Templates',
    status: 'draft',
