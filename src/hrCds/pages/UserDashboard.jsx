...
const UserDashboard = () => {
  ...
  const handleRefresh = useCallback(() => {
    ...
    fetchAttendanceData(true);
    fetchDashboardActivity(); // Also refresh activities
  }, [loading.attendance, fetchAttendanceData, fetchDashboardActivity]);
