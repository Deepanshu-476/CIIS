...
const PATH_TO_ROUTE = {
  ...
  'client-task-management': '/client/task-management',
  'client-admin-task-create': '/client/admin-task-create',
...
const TYPE_TO_ROUTE = {
  ...
  task_client: '/client/task-management',
  client_task: '/client/task-management',
  ...
  asset_return_requested: '/ciisUser/my-assets',
  asset_return_deposit_submitted: '/ciisUser/emp-assets',
  asset_return_verified: '/ciisUser/my-assets',
